...
{
    [TestFixture, Description("Runs a battery tests to see if Asynchronous network IO operations work correctly.")]
    public class AsyncHttpFeedFactoryTests : BaseMultiTestCase
    {
